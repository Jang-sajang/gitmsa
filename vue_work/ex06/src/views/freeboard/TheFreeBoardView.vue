<template>
    <div>
        ...
        <div class="">
            <button class="relative inline-block px-8 py-3 font-bold text-white bg-gradient-to-r from-pink-500 via-red-500
             to-yellow-500 rounded-lg shadow-lg hover:shadow-2xl hover:bg-gradient-to-l focus:outline-none focus:ring-4
              focus:ring-yellow-300 transition-all duration-300 ease-in-out transform hover:scale-105" @click="pageMove(idx)">수정</button>
            <button class="relative inline-block px-8 py-3 font-bold text-white bg-gradient-to-r from-pink-500 via-red-500
             to-yellow-500 rounded-lg shadow-lg hover:shadow-2xl hover:bg-gradient-to-l focus:outline-none focus:ring-4
              focus:ring-yellow-300 transition-all duration-300 ease-in-out transform hover:scale-105" @click="doDelete(idx)">삭제</button>
        </div>
    </div>
    </div>
</template>
