<template>
  <div class="p-10 mt-10 ml-3">
    <div>
      <h1 class="text-3xl font-bold text-blue-900">마이페이지</h1>
    </div>
      ...
      <div class="flex items-center justify-center p-3">
        <div class="flex p-3 bg-white rounded-xl">
          ...
          <aside>
            <img
              v-if="role === '학원생'"
              src="../images/stude.jpg"
              alt="Student Image"
              class="w-40"
            />
            <img
              v-else-if="role === '선생님'"
              src="../images/Teacha.jpg"
              alt="Teacher Image"
              class="w-40"
            />
            <img
    ...
    <div>
      <h1 class="mt-1 text-3xl font-bold text-blue-900">내 강좌</h1>
    </div>
    <div class="w-[68rem] p-5">
